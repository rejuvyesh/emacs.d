...
(dolist (pattern '("/\\.gitconfig\\'" "/\\.git/config\\'")) (add-to-list 'auto-mode-alist (cons pattern 'gitconfig-mode)))

;;;***

;;;### (autoloads nil nil ("gitconfig-mode-pkg.el") (20904 37302
;;;;;;  644598 509000))
