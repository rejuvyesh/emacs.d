...
(define-abbrev-table 'dactyl-mode-abbrev-table '())
...
(define-abbrev-table 'global-abbrev-table
  '(
    ...
    ("drnik" "drink" nil 0)
    ("dstamp" "" (lambda nil (insert (format-time-string "%Y%m%d" (time-add (current-time))))) 4)
    ("eclair" "eclair" nil 0)
    ("efel" "feel" nil 0)
    ...
    ("mysefl" "myself" nil 0)
    ("myu" "my" nil 0)
    ("myurl" "http://rejuvyesh.com/" nil 0)
    ("nad" "and" nil 1)
    ("naive" "naive" nil 0)
